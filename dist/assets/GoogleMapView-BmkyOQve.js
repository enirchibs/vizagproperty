import{r as o,j as s}from"./index-lP3AoCTO.js";import{g as B,a as E,w as F,M as N,V as z}from"./googleMaps-BYCgxrLQ.js";function R(e){return e>=1e7?`₹${(e/1e7).toFixed(2)} Cr`:e>=1e5?`₹${(e/1e5).toFixed(2)} L`:`₹${e.toLocaleString()}`}function $(e){var a;const c=((a=e.images)==null?void 0:a[0])||"/placeholder-property.jpg",p=e.location||e.city||"Visakhapatnam",w=e.bedrooms&&e.bedrooms>0?`${e.bedrooms} BHK`:"",v=e.area_sqft?`${e.area_sqft.toLocaleString()} sqft`:"",d=[w,v].filter(Boolean).join(" · ");return`
    <div style="
