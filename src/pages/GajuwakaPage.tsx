        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            <div className="lg:col-span-2">
              ...
              <button
                onClick={() => openWhatsApp('Hi Vizag Property Experts, I am looking for property in Gajuwaka, Vizag')}
          ...
          {loading ? (
            ...
            <div className="text-center py-12 bg-gray-50 rounded-2xl">
              ...
              <p className="text-gray-600 mb-6">We couldn't find any properties in Gajuwaka matching your search</p>
              <button
                onClick={() => openWhatsApp('Hi Vizag Property Experts, I searched for property in Gajuwaka but found no results. Please share matching options.')}
