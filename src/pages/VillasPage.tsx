...
import { Search, MapPin, Shield, TrendingUp, Home, Building2, CheckCircle2, ArrowRight, Phone, Sparkles } from 'lucide-react'
          ...
          <div className="max-w-3xl">
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-2">
              <div className="flex gap-2">
                <input
                  type="text"
                  placeholder="Search luxury villas in Madhurawada, Yendada, Rushikonda..."
                  value={searchQuery}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {loading ? (
            ...
            <div className="text-center py-12 bg-gray-50 rounded-2xl">
              ...
              <p className="text-gray-600 text-lg">New luxury villas coming soon!</p>
            </div>
          )}
